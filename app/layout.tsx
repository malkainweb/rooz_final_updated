...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://myrooz.com/special"), // Replace with your actual domain
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://myrooz.com/special", // Replace with your actual domain
    siteName: "ROOZ",
    title:
  ...
  return (
    <html lang="en">
      <Script
        ...
        })(window, document, "clarity", "script", 'vcek3czin5');`,
        }}
      />
      <head>
        {/* Additional SEO tags */}
